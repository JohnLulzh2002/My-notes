...
[website](https://deepu.tech/my-beautiful-linux-development-environment/)

![My beautiful Linux development environment](https://thepracticaldev.s3.amazonaws.com/i/8ap820z2y55e423dta8h.png)

![Deepu K Sasidharan](https://www.gravatar.com/avatar/7f408bc67dc9ae3b288ee92d16d3c4c2?s=250&d=mm&r=x) [Deepu K Sasidharan](https://www.deepu.tech)

| 16 Jun 2019 | 5 mins read 

**This is part of my "Linux environment for developers" series**

1.  **My beautiful Linux development environment**
2.  [Must have GNOME extensions](https://deepu.tech/must-have-gnome-plugins/)
3.  [Configure a beautiful terminal on Unix with Zsh](https://deepu.tech/configure-a-beautiful-terminal-on-unix/)
4.  [My VS Code setup - Making the most out of VS Code](https://deepu.tech/make-the-most-out-of-vscode/)
5.  [The state of Linux as a daily use OS in 2021](https://deepu.tech/the-state-of-linux-on-desktops/)
6.  [My sleek and modern Linux development machine in 2021](https://deepu.tech/my-beautiful-linux-development-environment-2021/)
...
![img](https://thepracticaldev.s3.amazonaws.com/i/3zajm5va5xplo9mg7804.png)
...
![img](https://thepracticaldev.s3.amazonaws.com/i/it61sd8sldm00nipfiy4.png)
...
![img](https://thepracticaldev.s3.amazonaws.com/i/h6w1qmxd2mvs88bl0ki7.png)
...
![img](https://thepracticaldev.s3.amazonaws.com/i/flq8pew1hr6l1hwj6egw.png)
...
>   This has been a good day, upgraded to [#Fedora](https://twitter.com/hashtag/Fedora?src=hash&ref_src=twsrc^tfw) 30 and hibernate started to work again. Sweet. I was putting off tinkering that for a long time. [#Linux](https://twitter.com/hashtag/Linux?src=hash&ref_src=twsrc^tfw)
>
>   — Deepu K Sasidharan ( ദീപു, தீபு, दीपू ) (@deepu105) 
>
>   June 14, 2019
